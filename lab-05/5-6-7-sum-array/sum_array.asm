...
section .data
    ...
    d_word_array dd 1392, 12544, 7992, 6992, 7202, 27187, 28789, 17897, 12988, 17992
...
add_square_dword_array_element:
	mov eax, dword [d_word_array + ecx * 4 - 4]
	mul eax
	add ebx, eax
	loop add_square_dword_array_element
